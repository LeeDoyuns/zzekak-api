...
class AppointmentMissionUseCase(
    ...
    fun updateMissionStatus(body: UpdateMissionStatusCommand): List<AppointmentUserMissionQuery> =
        appointmentMissionRepo.updateMissionStatus(
            body,
        ).run {
            appointmentMissionRepo.findAllByAppointmentId(body.appointmentId, AppointmentUserMissionQuery::class)
        }
}
